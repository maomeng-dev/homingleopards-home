...
<!--            <li><a href="#" target="_blank" title="友情链接" rel="noopener">友情链接</a></li>-->
            <li><a title="微信公众号" class="footer-layer-btn"><i class="fa fa-weixin" aria-hidden="true"></i> <span class="footer-layer-wrap"><img src="<? fe('/img/common/maomeng-qr.png') ?>" alt=""></span></a></li>
